        ...
        <div class="mb-2"> 
            ...
            <table class=" table table-bordered table-striped table-hover">
                ...
                <tbody>
                   ...
                   <td>{{ $plenaris->vege }}</td>
                   <td><a href="{{ route('dashboard.plenaris.edit', $plenaris->id) }}" class="btn btn-primary">Edit</a></td>
                   <td>
                       <form action="{{ route('dashboard.plenaris.delete', $plenaris->id) }}" method="post">
                           @csrf
                           @method('DELETE')
